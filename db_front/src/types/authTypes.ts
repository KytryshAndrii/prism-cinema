import { z } from "zod";
import type { authResponseSchema, loginRequestSchema, movieDetailsResponseSchema, movieRequestSchema, registerRequestSchema, rootStateSchema } from "../schemas/authSchemas";
